...
class CarDetails extends Component {
   ...
   bookingTheCar = () => {
      ...
      bodyFormData.append('vehicle_id', cart.product.id);
      bodyFormData.append('dates', cart.dates);
      bodyFormData.append('pickup_location', cart.pickup_location);
      bodyFormData.append('return_location', cart.return_location);
   ...
   render() {
      const {t} = this.props
      // const product = this.state.cart[this.state.]
      return (
         <>
